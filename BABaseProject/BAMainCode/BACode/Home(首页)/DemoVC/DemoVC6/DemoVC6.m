...
- (void)notBtnClick:(UIButton *)sender
{
    ...
    NSInteger time = [[NSString ba_time_getCurrentDateTransformTimeStampYMDHMS] integerValue] + 10 - [[NSString ba_time_getCurrentDateTransformTimeStampYMDHMS] integerValue];
